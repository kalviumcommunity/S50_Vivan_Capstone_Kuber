    ...
    <>
      ...
      <div className="flex ml-20">
        <div className="bg-white rounded-lg p-6 space-y-4">
          ...
          <div className="flex">
            <div className="bg-sky-300 h-32 w-72 rounded-lg flex items-center space-x-4 p-4">
              <img
            ...
            <div className="bg-sky-300 ml-20 h-32 w-72 rounded-lg flex items-center space-x-4 p-4">
              <img
                className="h-24 w-24 border-gray-950 border-2 rounded-full"
                src={wonder}
                alt="logo_black"
