      ...
      <div className="flex w-screen justify-evenly">
        <div className="font-semibold text-center w-2/5 ">
          ...
          <h2 className="text-xl ">
            There is a flat of 5% fee for selling your gift card/voucher on
            cansell. This fee is not levied at the time of posting, shall be
            deducted during payouts
          </h2>
          <h1 className="text-3xl text-cyan-400">
          ...
          <h2 className="text-xl ">
            ...
            approved, you post shall go live At the time of go live you shall be
            intimated via SMS. On purchase, you shall be notified via SMS to
            your registered phone. Payouts shall happen on purchase
            confirmation, team from Cansell will reach out to you for payout
            options
          </h2>
          <h1 className="text-3xl text-cyan-400">
