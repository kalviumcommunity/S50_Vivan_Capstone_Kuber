    ...
    <>
      ...
      <div className="flex justify-evenly h-5/6">
        <div>
          ...
          <img className="ml-28 mt-36 animate-bounce" src={discount} alt={discount} />
        </div>
        <div className="w-3/6 mt-28 h-3/6">
          <div className="bg-amber-200 w-7/12 rounded-2xl h-4/6 ml-36">
            ...
            <button className="w-36 bg-amber-300 text-black p-2 rounded-lg mt-5 mb-5 ml-52 font-semibold ">
              Submit
            </button>
          </div>
        </div>
      ...
      <div className="flex w-screen justify-evenly">
        <div className="font-semibold text-center w-2/5 ">
          <h1 className="text-3xl text-cyan-400 " >What is the charge for selling my gift card/ voucher?</h1>
          <h2 className="text-xl ">There is a flat of 5% fee for selling your gift card/voucher on cansell. This fee is not levied at the time of posting, shall be deducted during payouts</h2>
          <h1 className="text-3xl text-cyan-400">How will I be notified about the progress?</h1>
          <h2 className="text-xl ">At the time of listing, you shall be contacted if there is information needed on your posting, once all the information is approved, you post shall go live At the time of go live you shall be intimated via SMS.
             On purchase, you shall be notified via SMS to your registered phone. Payouts shall happen on purchase confirmation, team from Cansell will reach out to you for payout options</h2>
          <h1 className="text-3xl text-cyan-400">What are the payout options?</h1>
          <h2 className="text-xl ">You can choose from the following Payout options</h2>
        </div>
        <div>
          <img src={fox} alt={fox} />
        </div>
